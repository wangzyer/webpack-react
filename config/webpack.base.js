...
const IJJPlugin = require('./ijijin-webpack-plugin');
...
module.exports = options => {
    ...
    let plugins = [
        ...
        new IJJPlugin({
            viewportWidth: 750,
            isBuild: options.config === 'production',
            isProd: options.prod
        })
    ];
    return {
                    ...
                    use: [
                        ...
                        },
                        {
                            ...
                            options: {
                                plugins: [
                                    require('autoprefixer')()
                                ].concat(isMobile ? [require('postcss-px-to-viewport')({
                                    unitToConvert: 'px',
                                    ...
                                    mediaQuery: true,
                                    replace: true,
                                    exclude: [/ijijin_builder/, /ijijin-view/]
                                })] : [])
                            }
                        },
                        {
